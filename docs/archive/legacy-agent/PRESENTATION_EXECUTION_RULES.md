...
7. the matching `docs/roadmap/phases/` brief only if the task is phase- or handoff-specific
...
- use `docs/presentation/PRESENTATION_ARCHITECTURE.md` for runtime/data boundaries
