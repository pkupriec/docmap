...
10. `docs/presentation/PRESENTATION_ARCHITECTURE.md`
11. `PRESENTATION_DATA_CONTRACT.md`
12. `PRESENTATION_API_SPEC.md`
13. `PRESENTATION_UX_SPEC.md`
14. `docs/roadmap/phases/phase13_map_geometry.md`
15. `docs/roadmap/phases/phase15_hierarchical_document_aggregation.md`
