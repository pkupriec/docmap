...
- `docs/archive/legacy-agent/EXECUTION_SPEC.md`
- `docs/archive/legacy-agent/PRESENTATION_EXECUTION_RULES.md`
- `docs/roadmap/handoffs/MAP_GEOMETRY_HANDOFF.md`
...
- `docs/roadmap/phases/phase12_presentation_ux_iteration_1.md`
- `docs/roadmap/phases/phase12_code_alignment.md`
- `docs/roadmap/phases/phase12_execution_checklist.md`
